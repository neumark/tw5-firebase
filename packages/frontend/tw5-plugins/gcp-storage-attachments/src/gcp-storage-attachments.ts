...
import { maybeApply } from '../../../../shared/src/util/map';
import { TW5ImportFileInfo } from '../../../tw5-shared/src/tw5-types';
...
const getURL = (metadata: any) =>
  `https://firebasestorage.googleapis.com/v0/b/${metadata.bucket}/o/${encodeURIComponent(metadata.fullPath)}?alt=media`;
