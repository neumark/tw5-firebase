...
import { Tiddler } from '../shared/src/model/tiddler';
    ...
    importTiddlers: {
      ...
      handler: async (args: Arguments) => {
        const tiddlerStore = container
          ...
          .createTiddlerStore(superAdmin(args.wiki as string), args.wiki as string);
        // TODO: validation
        ...
        for (const tiddler of allTiddlers) {
          tiddlerStore.create(DEFAULT_BAG, tiddler.title, tiddler);
        }
      },
    },
  };
