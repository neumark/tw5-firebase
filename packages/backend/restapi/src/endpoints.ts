...
import { FirebaseConfig } from '../../shared/src/model/config';
...
import { HTTPNamespacedTiddler, PartialTiddlerData } from '../../shared/src/model/tiddler';
import { Logger } from '../../shared/src/util/logger';
import { mapOrApply, maybeApply } from '../../shared/src/util/map';
import { Component } from '../backend-shared/src/ioc/components';
import { tiddlerDataSchema } from '../backend-shared/src/schema';
import { getValidator } from '../backend-shared/validator';
import { firebaseConfig } from '../backend-shared/src/config-reader';
