...
export const objReduce = <V, A>(fn:(acc:A, k:string, v:V)=>A, input:{[key:string]:V}, acc0?:A):A => Object.entries(input).reduce((acc:A, [k, v]:[k:string, v:V]) => fn(acc, k, v), acc0 || {} as A);