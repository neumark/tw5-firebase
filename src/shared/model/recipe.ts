...
export const defaultRecipe: Recipe = {
    read: [{ variable: VARIABLE_PERSONAL_BAG }, { bag: BUILTIN_BAG_CONTENT }, { bag: BUILTIN_BAG_SYSTEM }],
    write: [{ variable: VARIABLE_PERSONAL_BAG }, { bag: BUILTIN_BAG_CONTENT }, { bag: BUILTIN_BAG_SYSTEM }],
};
